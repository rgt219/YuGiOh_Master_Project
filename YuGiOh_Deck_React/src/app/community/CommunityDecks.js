                                        ...
                                        <Card.Body className="d-flex flex-column justify-content-between p-3">
                                            <div>
                                                <div className="my-3 d-flex justify-content-center align-items-center position-relative fanned-container" style={{ height: '220px', width: '100%' }}>
                                                    ...
                                                    <img src={`https://cards.erregeteygo.com/card-images/${fannedCardIds[0]}.jpg`} alt="Card 1" className="border border-info border-opacity-25 card-left" style={{ height: '170px', objectFit: 'contain' }} onError={(e) => { e.target.src = `https://images.ygoprodeck.com/images/cards/${fannedCardIds[0]}.jpg`; }} />
                                                    <img src={`https://cards.erregeteygo.com/card-images/${fannedCardIds[2]}.jpg`} alt="Card 3" className="border border-info border-opacity-25 card-right" style={{ height: '170px', objectFit: 'contain' }} onError={(e) => { e.target.src = `https://images.ygoprodeck.com/images/cards/${fannedCardIds[2]}.jpg`; }} />
                                                    <img src={`https://cards.erregeteygo.com/card-images/${fannedCardIds[1]}.jpg`} alt="Card 2" className="border border-info card-center" style={{ height: '185px', objectFit: 'contain' }} onError={(e) => { e.target.src = `https://images.ygoprodeck.com/images/cards/${fannedCardIds[1]}.jpg`; }} />
                                                </div>
