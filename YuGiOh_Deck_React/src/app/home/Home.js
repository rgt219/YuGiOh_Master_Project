...
export default function Home({ user }) {
    ...
    return (
        <div className="md-theme-bg" style={{ backgroundColor: '#06080c', minHeight: '100vh', overflowX: 'hidden', fontFamily: "'Cascadia Mono', monospace" }}>
            ...
            <div className="container md-content-panel position-relative d-flex align-items-center p-0 mt-5 mb-0 shadow-lg" style={{ backgroundColor: '#0a0d14', overflow: 'hidden', minHeight: '728px', borderRadius: '6px', border: '1px solid rgba(0, 210, 255, 0.3)' }}>
            ...
            <div className="container md-content-panel position-relative d-flex align-items-center p-0 mt-0 mb-0 shadow-lg" style={{ backgroundColor: '#0a0d14', overflow: 'hidden', minHeight: '728px', borderRadius: '6px', border: '1px solid rgba(0, 210, 255, 0.3)' }}>
            ...
            {/* 8. CONTACT SECTION */}
            <div className="container md-content-panel position-relative d-flex align-items-center p-0 mt-0 mb-5 shadow-lg" style={{ backgroundColor: '#0a0d14', overflow: 'hidden', minHeight: '728px', borderRadius: '6px', border: '1px solid rgba(0, 210, 255, 0.3)' }}>
