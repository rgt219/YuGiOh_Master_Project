...
// 1. Fetcher maps all essential card fields into memory once
...
export default function CardApi({ onAddCard, onDeleteCard, cardList }) {
    ...
    // 2. INSTANT HOVER: No network call needed!
                ...
                {filteredCards.map(card => (
                    <div key={card.id} className="gallery__item">
                        <div className="card-container">
                            ...
                            >
                                {/* 3. Optimized Image with Aspect Ratio to prevent layout jumps */}
                                <img 
