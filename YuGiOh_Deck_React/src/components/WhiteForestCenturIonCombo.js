export const whiteForestCenturIonMain = {
    ...
    steps: [
        ...
        { id: 3, instruction: "CL1 Silvy (Add Aphes), CL2 Tales (Set itself).", cardId: "99289828", zone: "STZ_1", aiCommentary: "This is crucial. Chain-blocking with Tales protects your search from Ash Blossom." },
        { id: 4, instruction: "Synchro Summon Rciela, Sinister Soul.", cardId: "77313225", zone: "EMZ_1", aiCommentary: "Rciela is our primary searcher and a Level 6 Tuner." },
        ...
        { id: 8, instruction: "Synchro Summon Diabell, Queen of the White Forest.", cardId: "14307929", zone: "MMZ_3", aiCommentary: "Diabell is the boss of the engine, enabling massive recursion." },
        ...
        { id: 12, instruction: "Synchro Summon Centur-Ion Auxila.", cardId: "71858682", zone: "EMZ_1", aiCommentary: "The bridge into the Centur-Ion engine begins here." },
        ...
        { id: 16, instruction: "Trudea Eff: SS itself from S/T zone.", cardId: "42493140", zone: "MMZ_5", aiCommentary: "Transitioning from backrow to monster." },
        { id: 17, instruction: "Trudea Eff: Set itself and Primera from Deck.", cardId: "15005145", zone: "STZ_3", aiCommentary: "The signature Centur-Ion setup move." },
        { id: 18, instruction: "Primera Eff: SS itself from S/T zone.", cardId: "15005145", zone: "MMZ_2", aiCommentary: "Primera is our tuner for the high-level plays." },
        ...
        { id: 20, instruction: "Synchro Summon Muddy Mudragon.", cardId: "84040113", zone: "MMZ_3", aiCommentary: "Using Primera and Elzette. Mudragon is our Fusion substitute." },
        ...
        { id: 23, instruction: "Muddy Mudragon Eff: Fusion Summon Red-Eyes Dark Dragoon.", cardId: "37818794", zone: "MMZ_3", aiCommentary: "Using itself as a substitute. Now we have an omni-negate." },
        { id: 24, instruction: "Banish Phalanx: SS Auxila from GY.", cardId: "71858682", zone: "MMZ_5", aiCommentary: "Bringing back the Level 12 Synchro for the Crimson Dragon target." },
        { id: 25, instruction: "Synchro Summon Crimson Dragon.", cardId: "63436931", zone: "MMZ_1", aiCommentary: "The ultimate facilitator for Level 12 Synchros." },
        ...
        { id: 27, instruction: "Crimson Dragon Eff: Target Auxila, SS Cosmic Blazar Dragon.", cardId: "21123811", zone: "MMZ_1", aiCommentary: "The end of the line. Cosmic Blazar can negate anything." },
        { id: 28, instruction: "Go to End Phase.", cardId: "endphase", zone: "NONE", aiCommentary: "Cleaning up the board for turn zero plays." },
        { id: 29, instruction: "Auxila End Phase Eff: Set Primera in S/T.", cardId: "15005145", zone: "STZ_2", aiCommentary: "Ensuring we have a follow-up SS during the opponent's turn." }
    ]
};