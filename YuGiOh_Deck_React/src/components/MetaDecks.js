      ...
      <div className="md-theme-bg min-vh-100 d-flex justify-content-center align-items-center mt-5">
        ...
        >
          <Card.Body>
            ...
            <p className="text-white-50 small mt-2 m-0">Synchronizing tournament archives from MongoDB</p>
          </Card.Body>
        </Card>
      </div>
    );
    ...
    <div className="md-theme-bg min-vh-100 py-5 mt-5">
      <Container>
        ...
        <Row xs={1} md={2} lg={3} className="g-4">
          {metaDecks.map((deck) => {
            // Bracket notation eliminates editor type-checking redlines
            ...
            // Extract cover image from first card in Main Deck
                    ...
                    <div>
                      ...
                      <div className="d-flex justify-content-between align-items-center mb-3">
                        <span className="badge bg-dark border border-secondary text-info">
                          FORMAT: {deck?.format || deck?.Format || 'TCG'}
                        </span>
                      </div>

                      {/* Card Count Breakdown Box */}
                      <div 
